...
if authentication_status==True:
    ...
    with dataset:
<<<<<<< HEAD
        datasource = '/Users/eceaks/PycharmProjects/streamlite/Anaveri2.xlsx'
...
>>>>>>> origin/main
    ...
    if page=="Ana Sayfa":
        # Inserted Animation #
        lottie_coding = load_lottiefile("70106-website-performance.json")
        ...
        #Inserted Animation
        lottie_coding = load_lottiefile("87792-analysis.json")
        ...
        #---#
        lottie_coding = load_lottiefile("81231-time-go.json")
...
=======
        lottie_coding = load_lottiefile(
            "72879-customer-support-help-support-agent.json")
        st_lottie(lottie_coding, speed=1, reverse=False, loop=True, quality="low", height=None, width=None,
                  key=None)
>>>>>>> origin/main
